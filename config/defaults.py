...
# Momentum
_C.SOLVER.STAGE1.MOMENTUM = 0.9#这意味着在 Stage 1 阶段的梯度更新过程中，之前的梯度方向对当前更新有较大的影响力，以加速训练和提高稳定性
...
_C.SOLVER.STAGE1.LOG_PERIOD = 100#每隔100个迭代周期打印log，迭代周期的计算为数据集样本数/bacth_size
